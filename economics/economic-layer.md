...
1. Observe slot-scoped game state
2. Propose actions from model policy
3. Execute validated action batches
4. Adapt continuously across the match

{% hint style="success" %}
**This is not a roadmap item.** Autonomous agent play runs in production today.
{% endhint %}
...
* In the current MVP, entitlement is **allow-all by default**
* The architecture is ready to move from open participation to **programmable access and gated monetization**
* Activation is pending policy configuration — not engineering
...
* ⏳ **Productization** — linking cost curves to payout curves
